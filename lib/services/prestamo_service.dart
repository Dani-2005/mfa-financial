...
class PrestamoService {
  ...
  Future<String> registrarAbonoCapital({
    ...
    await DatabaseService.instance.query(
      ...
      "VALUES (:codigo, NULL, :prestamoId, 'Abono_Capital', :fecha, :monto, :concepto, :metodo, :referencia)",
      {
        'codigo': codigoRecibo,
        'prestamoId': prestamoId,
        'fecha': _formatDate(fechaEmision),
  ...
  Future<String> registrarLiquidacionTotal({
    ...
    await DatabaseService.instance.query(
      'INSERT INTO recibos_pagos '
      "(codigo_recibo, cuota_id, prestamo_id, tipo_movimiento, fecha_emision, monto_total_pagado, descripcion_concepto, metodo_pago, referencia) "
      "VALUES (:codigo, NULL, :prestamoId, 'Liquidacion_Total', :fecha, :monto, :concepto, :metodo, :referencia)",
      {
        'codigo': codigoRecibo,
        'prestamoId': prestamoId,
        'fecha': _formatDate(fechaEmision),
    ...
    await finalizarPrestamo(prestamoId: prestamoId, codigoReferencia: codigoReferencia);

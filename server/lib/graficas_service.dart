...
/// Puerto del `GraficasService` de la app. `fetchCapitalNuevoPorMes` no está
/// aquí: en la app sigue delegando en `DashboardService.fetchCapitalSummary`,
/// que ya habla con este mismo servidor, así que no hace falta duplicarlo.
